...
// Google Maps + Photo Slider + Filtering Logic
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof google !== 'undefined') {
        ...
        // Google Maps will call initMap when loaded
...
function updateMarkers() {
    ...
    filteredCampings.forEach(camping => {
        ...
        const marker = new google.maps.Marker({
            ...
            icon: icon,
            title: camping.name,
            animation: camping.fireBan ? google.maps.Animation.BOUNCE : null
        });

        const infoWindow = new google.maps.InfoWindow({
            content: createInfoWindowContent(camping),
            maxWidth: 350
        });
        ...
        marker.addListener('click', () => {
            ...
            // Initialize slider after info window opens
...
// Create info window content with photo slider
function createInfoWindowContent(camping) {
    ...
    return `
        <div class="custom-info-window">
            ...
            <div class="info-content">
                ...
                <div class="info-detail">⭐ ${camping.rating}/5 • ${camping.priceRange}</div>
...
function nextSlide(campingId) {
    ...
    if (!camping || camping.photos.length <= 1) return;
